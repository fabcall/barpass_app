      ...
      routes: [
        ShellRoute(
          ...
          routes: [
            ...
            GoRoute(
              path: AppRoute.login.path.substring(
                1,
              ), // Remove leading '/' para rota relativa
              ...
              routes: [
                GoRoute(
                  ...
                  routes: [
                    // Rota aninhada para OTP após password reset
                    GoRoute(
                    ...
                    // Rota para mudança de senha após verificação do OTP
                    GoRoute(
            ...
            GoRoute(
              path: AppRoute.registration.path.substring(
                1,
              ),
    ...
    StatefulShellRoute.indexedStack(
      ...
      branches: [
        ...
        StatefulShellBranch(
          routes: [
            GoRoute(
              path: AppRoute.conta.path,
              name: AppRoute.conta.name,
              builder: (context, state) => const ContaPage(),
              routes: [
                GoRoute(
                  path: AppRoute.contaTransacoes.path
                      .replaceAll(AppRoute.conta.path, '')
                      .substring(1), // 'transacoes'
...
class ContaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _buildPage(
      ...
      actions: [
        ElevatedButton(
          // ✅ Usando navegação type-safe
          onPressed: () => context.navigate.account.toTransactions(),
          child: const Text('Transações'),
        ),
        ElevatedButton(
          onPressed: () => context.navigate.account.toStatement(),
          child: const Text('Extrato'),
        ),
        ElevatedButton(
          onPressed: () => context.navigate.account.toCards(),
  ...
  Widget build(BuildContext context) {
    return _buildPage(
      ...
      actions: [
        ElevatedButton(
          // ✅ Usando navegação type-safe
          onPressed: () => context.navigate.favorites.toItem('456'),
