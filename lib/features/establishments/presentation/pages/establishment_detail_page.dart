...
class _EstablishmentDetailPageState
  ...
  Widget build(BuildContext context) {
    // Observa o estado do estabelecimento
  ...
  // Tela quando o estabelecimento não é encontrado
  ...
  Widget _buildLoadingScreenWithSkeleton() {
    return Scaffold(
      ...
      body: Skeletonizer(
        child: Stack(
          children: [
            // Skeleton do carrossel de fotos
  ...
  // Tela principal com os detalhes
