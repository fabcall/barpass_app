...
class _FloatingActionButtonWidgetState extends State<FloatingActionButtonWidget>
  ...
  void _handleTapDown(TapDownDetails details) {
    ...
    // Inicia a animação de rotação e escala quando pressionado
  ...
  void _handleTapUp(TapUpDetails details) {
    ...
    // Para a animação e volta ao estado inicial
  ...
  void _handleTapCancel() {
    ...
    // Para a animação e volta ao estado inicial se cancelado
    _animationController.reverse();
  }
...
class CenterDockedFabLocation extends FloatingActionButtonLocation {
  ...
  const CenterDockedFabLocation({
    this.offset = AppSpacing.fabOffset,
  });
