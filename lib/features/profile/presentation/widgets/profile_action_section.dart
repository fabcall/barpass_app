...
import 'package:barpass_app/features/profile/presentation/widgets/location_permission_tile.dart';
import 'package:barpass_app/features/profile/presentation/widgets/notification_tile.dart';
          ...
          ProfileActionCard(
            children: [
              ...
              ProfileActionTile(
                ...
                onTap: () {
                  HapticFeedback.lightImpact();
                  context.navigate.auth.goRegister();
                },
              ),
            ],
          ),
          ...
          ProfileActionCard(
            children: [
              ProfileActionTile(
                ...
                onTap: () {
                  HapticFeedback.lightImpact();
                  context.navigate.profile.pushEdit();
                },
              ),
              ProfileActionTile(
          ...
          children: [
            ProfileActionTile(
              ...
              onTap: () {
                HapticFeedback.lightImpact();
                if (isAuthenticated) {
                  context.navigate.favorites.goFavorites();
                } else {
                  context.navigate.auth.goLogin();
                }
              },
