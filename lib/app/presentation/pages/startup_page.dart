...
class _StartupPageState extends ConsumerState<StartupPage>
  ...
  late AnimationController _logoController; // Apenas controller da logo
  late Animation<double> _logoScaleAnimation; // Scale da logo
  late Animation<double> _logoOpacityAnimation; // Opacity da logo
  ...
  void _loadRiveFile() {
    rootBundle.load('assets/json/logo_animation.json').then(
      (data) async {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(appStateProvider, (previous, next) {
      ...
      // Para a animação de loading quando não estiver mais carregando
