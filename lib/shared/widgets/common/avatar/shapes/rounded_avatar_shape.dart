...
import 'package:barpass_app/shared/widgets/common/avatar/shapes/avatar_shape.dart';
...
class _RoundedClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    final double effectiveWidth = math.max(0.0, size.width - borderWidth);
    final double effectiveHeight = math.max(0.0, size.height - borderWidth);
    ...
    final adjustedRadius = Radius.circular(
      math.max(0.0, borderRadius - borderWidth / 2),
    );
