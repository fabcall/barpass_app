...
class BurntConstants {
  ...
  static const double defaultStackGap = 8.0;
  ...
  static const double baseTopPadding = 16.0;
  ...
  static const double dismissVelocityThreshold = -500.0;

  /// Maximum downward drag allowed.
  static const double maxDownwardDrag = 20.0;

  // --- Shadow System Constants ---

  /// Default primary shadow blur radius.
  static const double defaultPrimaryShadowBlur = 12.0;

  /// Default secondary shadow blur radius.
  static const double defaultSecondaryShadowBlur = 6.0;
  ...
  static const double defaultElevation = 12.0;

  /// Default size for preset icons.
  static const double defaultPresetIconSize = 20.0;
  ...
  static const double titleMessageSpacing = 4.0;
